...
def check_drinks(drink_name, drink_ingredients):
    ...
    return drink_name + ' ' + ending + 'ocktail'
...
def categorize_dish(dish_name, dish_ingredients):
    ...
    for category in categories:
        if dish_ingredients <= getattr(sets_categories_data,category):
...
def compile_ingredients(dishes):
    ...
    # set_dishes = set()
    # for item in dishes:
    #     set_dishes = set_dishes | set(item)
    # return set_dishes
...
def singleton_ingredients(dishes, intersection):
    ...
    # singleton_set = set()
    # for item in dishes:
    #     singleton_set = singleton_set | (set(item) - intersection)
